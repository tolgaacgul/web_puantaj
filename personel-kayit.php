    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo2" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="personel-kayit.html">Yeni Personel</a>
                        <a class="collapse-item" href="cards.html">Personel Listesi</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseBordro" class="collapse" aria-labelledby="headingTwo2" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Bordro İşlemleri</h6>
                        <a class="collapse-item" href="buttons.html">Bordro Girişi</a>
                        <a class="collapse-item" href="buttons.html">Raporlar</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseTanimler" class="collapse" aria-labelledby="headingTwo2" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="personel-gurup-tanimlari.html">Personel Gurup Tanımları</a>
                        <a class="collapse-item" href="buttons.html">Raporlar</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCariIslem" class="collapse" aria-labelledby="headingTwo2" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Personel Maaş Hesaplaması</a>
                        <a class="collapse-item" href="buttons.html">Personel Avans Girişi</a>
                        <a class="collapse-item" href="buttons.html">Raporlar</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid sedat">
                    ...
                    <form action="personel-kayit.php" method="post" class="row">
                        ...
                        <div class="col-6">
                            <h3>Personel Ücret Bilgileri</h3>
                            <div class="row">
                                <div class="col-4 mb-3">
                                ...
                                <div class="col-12 mt-1">
                                    <h4>Mesai Çalışma Bilgileri</h4>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="formGroupExampleInput" class="form-label">Mesai Çarpanı</label>
                                    <div class="d-flex">
                        ...
                        <div class="col-12">
                            <h3 class="mt-1">Personel Adres Bilgileri</h3>
                            <div class="row">
                                <div class="col-4">
